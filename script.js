   const hamburger = document.getElementById('hamburger');
    ...
    const animateOnScroll = () => {
      const elements = document.querySelectorAll('.service-card, .department-card, .doctor-card, .package-card');
    ...
    document.querySelectorAll('.service-card, .department-card, .doctor-card, .package-card').forEach(element => {
